...
import { Home, Users, Calendar, BookOpen, Award, FileText, User, LogOut } from "lucide-react"
...
const menuItems = [
  ...
  {
    title: "Atributos Egreso",
    icon: Award,
    url: "/atributos-egreso",
  },
  {
    title: "Reportes",
    icon: FileText,
    ...
    >
      ...
      <div className="mt-auto p-4 border-t border-[#70aad8] transition-all duration-300">
        <div className="flex items-center gap-2 hover-scale">
          ...
          <div>
            <p className="text-sm font-medium text-[#0045aa]">{username}</p>
          </div>
        </div>
      </div>
