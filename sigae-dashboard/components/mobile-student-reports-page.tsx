...
interface MobileStudentReportsPageProps {
  reportType: string
  period: string
...
export function MobileStudentReportsPage({
  reportType,
  period,
        ...
        <div>
          <Select defaultValue={reportType} onValueChange={handleReportTypeChange}>
            <SelectTrigger className="w-full">
              <SelectValue placeholder="Selección de tipo de reporte" />
            </SelectTrigger>
            <SelectContent>
